...
Texture.prototype.setSpritesheet = function (spritesheet) {
	// TODO: clear and draw
	Texture.prototype.currentSpritesheet.clear().draw(spritesheet, 0, 0);
	return this;
};
...
Texture.prototype.sprite = function (sprite, x, y, flipH, flipV, rot) {
	...
	if (!flipH && !flipV && !rot) {
		ctx.drawImage(this.currentSpritesheet.canvas, sx * 8, sy * 8, 8, 8, x, y, 8, 8);
		return this;
	}
	ctx.save();
	...
	ctx.drawImage(this.currentSpritesheet.canvas, sx * 8, sy * 8, 8, 8, 0, 0, 8, 8);
	ctx.restore();
	return this;
};
...
Texture.prototype.draw = function (img, x, y) {
	...
	this.ctx.drawImage(img, ~~(x + 0.5), ~~(y + 0.5));
	return this;
};
