...
Texture.prototype.draw = function (img, x, y) {
	if (img._isTexture) {
		this.ctx.drawImage(img.canvas, ~~x, ~~y);
	} else {
...
Texture.prototype.cls = Texture.prototype.clear;
...
window.rect = function (x, y, w, h) {
	return screen.rect(x, y, w, h);
};

window.rectfill = function (x, y, w, h) {
	return screen.rectfill(x, y, w, h);
};
