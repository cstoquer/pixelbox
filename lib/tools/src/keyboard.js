...
function keyChange(e, isPressed) {
	...
	switch (e.keyCode) {
		case 83 : if (ctrlKey && Panel.currentSelectedPanel) { Panel.currentSelectedPanel.save(); e.preventDefault(); break; } // S key : save
		case 90 : if (ctrlKey && Panel.currentSelectedPanel) { Panel.currentSelectedPanel.undo(); e.preventDefault(); break; } // Z key : undo
