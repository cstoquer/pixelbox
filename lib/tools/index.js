...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
function FileItem(item, parent) {
	var t = this;

	this.item = item;
	this.dom = createDiv('fileListItem', parent);
	this.parent = parent;
	this.content = createDiv('', this.dom); // TODO

	createDom('spawn', 'mapListItemName',  this.dom).innerText = item.name;
}
...
MapListPanel.prototype.addFileTo = function (obj, parent) {
	if (obj instanceof Image) {
		// TODO create item only on open
		var item = new FileItem(obj, parent);
	} else if (obj instanceof Object) {
		var container = new FileItem(obj, parent);
		for (var key in obj) {
			this.addFileTo(obj[key], container.content);
		}
	}
};
...
MapListPanel.prototype.setup = function (assets) {
	...
	for (var key in assets) {
		...
		this.addFileTo(assets[key], root);
	}
};
