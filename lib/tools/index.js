...
function MapPanel() {
	...
	clipSurface.style.width  = this._viewW * PIXEL_SIZE;
	clipSurface.style.height = this._viewH * PIXEL_SIZE;
	...
	function startDrag(e) {
		...
		function dragMove(e) {
			e.preventDefault();
			posX = clip(e.clientX - startX, -(self.map.width  * 8 - self._viewW) * PIXEL_SIZE - 1, 0);
			posY = clip(e.clientY - startY, -(self.map.height * 8 - self._viewH) * PIXEL_SIZE - 1, 0);
