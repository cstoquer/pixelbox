...
function createPaletteCell(parent, index, color) {
	...
	button(cell, function (e) {
		...
		dragManager.startDrag(e, 'paletteColor', cell, dummy);
	});
...
function MapEditorPanel() {
	...
	dragManager.on('dragStart', function () { dropAreas.style.display = ''; });
	dragManager.on('dragEnd',   function () { dropAreas.style.display = 'none'; });
