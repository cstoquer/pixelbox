...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
DragManager.prototype.startDrag = function (e, id, item) {
	var t = this;
	var d = document;
	...
	function onDragEnter() {
		this._dropHandle.onDragEnter && this._dropHandle.onDragEnter(id);
		currentDrop = this;
	}

	function onDragLeave() {
		this._dropHandle.onDragLeave && this._dropHandle.onDragLeave(id);
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
SpriteSheetPanel.prototype.onDragEnter = function (id) {
	if (id !== 'imageFile') return;
	this.dom.style.border = 'solid 3px #F00';
};

SpriteSheetPanel.prototype.onDragLeave = function (id) {
...
function MapEditorPanel() {
	...
	foreground.style.top      = background.style.top      = canvas.style.top      = '0px';
	foreground.style.left     = background.style.left     = canvas.style.left     = '0px';
	foreground.style.position = background.style.position = canvas.style.position = 'absolute';
	clipSurface.appendChild(background);
	clipSurface.appendChild(canvas);
	clipSurface.appendChild(foreground);
	...
	function startDrag(e) {
		...
		function dragMove(e) {
			...
			setPosition(background, t._posX, t._posY);
			setPosition(foreground, t._posX, t._posY);
		}
	...
	var resizeHandle = createDiv('mapResizeHandle', this.content);
...
MapEditorPanel.prototype.resizeViewport = function () {
	this._viewW = ~~Math.max(this._viewW, SPRITE_WIDTH * 14);
...
MapEditorPanel.prototype.resizeMap = function (w, h) {
	...
	background.style.width  = foreground.style.width  = this._canvas.style.width  = w * SPRITE_WIDTH  * PIXEL_SIZE + 'px';
	background.style.height = foreground.style.height = this._canvas.style.height = h * SPRITE_HEIGHT * PIXEL_SIZE + 'px';
	background.style.left   = foreground.style.left   = this._canvas.style.left   = this._posX + 'px';
	background.style.top    = foreground.style.top    = this._canvas.style.top    = this._posY + 'px';
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
MapEditorPanel.prototype.addBackground = function (img) {
	this.background.draw(img);
	// TODO save img to redraw on resize
};

//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
MapEditorPanel.prototype.addForeground = function (img) {
	this.foreground.draw(img);
	// TODO save img to redraw on resize
};
...
function ImageListItem(name, item, parent) {
	...
	button(this.dom, function (e) {
		dragManager.startDrag(e, 'imageFile', t.item);
	});
}
...
function FolderListItem(name, item, parent) {
	...
	function fold() {
		...
		t.dom.style.height = isOpened ? '' : '20px'; // FIXME
	}
...
MapListPanel.prototype.startDrag = function (item, e) {
	...
	createDom('span', 'mapListItemIndex', dummy).innerText = item.index;
	createDom('span', 'mapListItemName',  dummy).innerText = item.map.name || 'undefined';
