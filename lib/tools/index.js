...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
function FileListItem(item, parent) {
	var t = this;
...
MapListPanel.prototype.addFile = function (obj) {
	// TODO
	var item = new FileListItem(obj, this.list);
};
...
assetLoader.preloadStaticAssets(function onAssetsLoaded(error, result) {
	...
	// TODO part of mapList setup
	for (var key in assets) {
		if (key === 'maps') continue;
		// TODO recursion for folders
		if (assets[key] instanceof Image) {
			console.log(assets[key]);
			mapList.addFile(assets[key]);
		}
	}
