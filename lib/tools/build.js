...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
AssetListPanel.prototype.addFileTo = function (name, obj, parent) {
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
AssetListPanel.prototype.addMap = function (file, map) {
	var index = this.elems.length;
	this.elems.push(new MapListItem(file, index, map, this.mapList));
};
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
AssetListPanel.prototype.createNew = function () {
	// TODO lock if saving
	var t = this;
	...
	assetLoader.sendRequest(request, function (error) {
		...
		t.addMap('maps', data); // TODO: add in another file than 'data'
	});
};
...
},{"../../common/Map":2,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./FolderListItem":10,"./ListItem":11,"./Panel":14,"./dragManager":16,"./helper":18,"./resizeHandle":21,"./toolbox":22,"./tooltip":23}],8:[function(require,module,exports){
module.exports = {
	name: 'default brush',
...
},{"../../common/domUtils":5,"../../common/inherits":6,"./Brush":8,"./FolderListItem":10,"./Panel":14,"./helper":18,"./resizeHandle":21,"./toolbox":22,"./tooltip":23}],10:[function(require,module,exports){
var domUtils       = require('../../common/domUtils');
...
},{"../../common/domUtils":5,"./dragManager":16}],12:[function(require,module,exports){
var Panel        = require('./Panel');
var addTooltip   = require('./tooltip');
...
},{"../../common/Map":2,"../../common/Texture":3,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./Panel":14,"./dragManager":16,"./grid":17,"./helper":18,"./keyboard":20,"./resizeHandle":21,"./tooltip":23}],13:[function(require,module,exports){
...
},{"../../common/domUtils":5,"../../common/inherits":6,"./Panel.js":14,"./dragManager.js":16}],14:[function(require,module,exports){
var domUtils      = require('../../common/domUtils');
...
},{"../../common/domUtils":5,"./zIndexManager":24}],15:[function(require,module,exports){
var Panel        = require('./Panel.js');
...
},{"../../common/Texture":3,"../../common/domUtils":5,"../../common/inherits":6,"./Panel.js":14,"./dragManager.js":16,"./grid.js":17,"./tooltip.js":23}],16:[function(require,module,exports){
...
},{"../../common/EventEmitter":1,"../../common/domUtils":5,"../../common/inherits":6,"./zIndexManager":24}],17:[function(require,module,exports){
...
},{"../../common/Texture":3}],18:[function(require,module,exports){
// helper functions
...
},{"../../common/assetLoader":4,"./toolbox":22}],20:[function(require,module,exports){
var EventEmitter = require('../../common/EventEmitter');
var Panel        = require('./Panel.js');
...
},{"../../common/EventEmitter":1,"./Panel.js":14}],21:[function(require,module,exports){
var addTooltip = require('./tooltip.js');
var domUtils   = require('../../common/domUtils');
...
},{"../../common/domUtils":5,"./tooltip.js":23}],22:[function(require,module,exports){
var Panel       = require('./Panel.js');
var PixelboxMap = require('../../common/Map');
...
},{"../../common/Map":2,"./AssetListPanel.js":7,"./CustomToolsPanel.js":9,"./MapEditorPanel.js":12,"./PalettePanel.js":13,"./Panel.js":14,"./SpriteSheetPanel.js":15,"./keyboard.js":20}],23:[function(require,module,exports){
var createDiv     = require('../../common/domUtils').createDiv;
var zIndexManager = require('./zIndexManager');
...
},{"../../common/domUtils":5,"./zIndexManager":24}],24:[function(require,module,exports){
var zIndex = 0;
var elements = [];
