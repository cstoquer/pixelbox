...
var DEFAULT_TOOLS = {
	brushes: require('./Brush')
};

//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
function ToolItem(toolId, item, parent) {
	var t = this;
...
function CustomToolsPanel() {
	...
	for (var category in CUSTOM_TOOLS) {
		...
		if (DEFAULT_TOOLS[category]) {
			var item = new ToolItem('default', DEFAULT_TOOLS[category], list.content);
			// TODO
		}
...
},{"../../common/domUtils":5,"../../common/inherits":6,"./Brush":7,"./FolderListItem":9,"./Panel":13,"./helper":17,"./resizeHandle":20,"./tooltip":21}],9:[function(require,module,exports){
var domUtils       = require('../../common/domUtils');
...
},{"../../common/Map":2,"../../common/Texture":3,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./Panel":13,"./dragManager":15,"./grid":16,"./helper":17,"./keyboard":19,"./resizeHandle":20,"./tooltip":21}],11:[function(require,module,exports){
var Panel          = require('./Panel');
var addTooltip     = require('./tooltip');
var dragManager    = require('./dragManager');
var helper         = require('./helper');
...
},{"../../common/Map":2,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./FolderListItem":9,"./MapEditorPanel":10,"./Panel":13,"./dragManager":15,"./helper":17,"./resizeHandle":20,"./tooltip":21}],12:[function(require,module,exports){
...
},{"../../common/domUtils":5,"./zIndexManager":22}],14:[function(require,module,exports){
var Panel        = require('./Panel.js');
...
},{"../../common/Texture":3,"../../common/domUtils":5,"../../common/inherits":6,"./Panel.js":13,"./dragManager.js":15,"./grid.js":16,"./tooltip.js":21}],15:[function(require,module,exports){
...
},{"../../common/EventEmitter":1,"../../common/domUtils":5,"../../common/inherits":6,"./zIndexManager":22}],16:[function(require,module,exports){
...
},{"../../common/assetLoader":4,"./Brush.js":7,"./CustomToolsPanel.js":8,"./MapEditorPanel.js":10,"./MapListPanel.js":11,"./PalettePanel.js":12,"./Panel.js":13,"./SpriteSheetPanel.js":14,"./keyboard.js":19}],19:[function(require,module,exports){
var EventEmitter = require('../../common/EventEmitter');
var Panel        = require('./Panel.js');
...
},{"../../common/domUtils":5,"./tooltip.js":21}],21:[function(require,module,exports){
var createDiv     = require('../../common/domUtils').createDiv;
var zIndexManager = require('./zIndexManager');
...
},{"../../common/domUtils":5,"./zIndexManager":22}],22:[function(require,module,exports){
var zIndex = 0;
var elements = [];
