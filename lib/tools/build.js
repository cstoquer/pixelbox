...
},{"../../common/domUtils":5}],9:[function(require,module,exports){
...
function MapEditorPanel() {
	...
	function startDraw(e) {
		...
		function mouseMove(e, isStart) {
			...
			t.toolbox.brush.draw(x, y, isStart, t.toolbox);
			// if (keyboard.shift) {
			// 	t.map.remove(x, y);
			// } else {
			// 	var spritesheet = t.toolbox.spritesheet;
			// 	t.map.set(x, y, spritesheet.sprite, spritesheet.flipH, spritesheet.flipV, spritesheet.flipR);
			// }
		}
...
},{"../../common/Map":2,"../../common/Texture":3,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./Panel":12,"./dragManager":14,"./grid":15,"./helper":16,"./keyboard":18,"./resizeHandle":19,"./tooltip":20}],10:[function(require,module,exports){
var Panel          = require('./Panel');
var addTooltip     = require('./tooltip');
var dragManager    = require('./dragManager');
var helper         = require('./helper');
...
var inherits       = require('../../common/inherits');
var domUtils       = require('../../common/domUtils');
var mapEditor      = require('./MapEditorPanel');
...
MapListPanel.prototype.resize = function () {
	this.viewW = ~~Math.max(this.viewW, 200);
...
module.exports = mapListPanel = new MapListPanel();

},{"../../common/Map":2,"../../common/assetLoader":4,"../../common/domUtils":5,"../../common/inherits":6,"./FolderListItem":8,"./MapEditorPanel":9,"./Panel":12,"./dragManager":14,"./helper":16,"./resizeHandle":19,"./tooltip":20}],11:[function(require,module,exports){
...
},{"../../common/domUtils":5,"../../common/inherits":6,"./Panel.js":12,"./dragManager.js":14}],12:[function(require,module,exports){
// dom utilities
var domUtils  = require('../../common/domUtils');
var createDom = domUtils.createDom;
var createDiv = domUtils.createDiv;
...
},{"../../common/domUtils":5}],13:[function(require,module,exports){
var Panel        = require('./Panel.js');
...
},{"../../common/Texture":3,"../../common/domUtils":5,"../../common/inherits":6,"./Panel.js":12,"./dragManager.js":14,"./grid.js":15,"./tooltip.js":20}],14:[function(require,module,exports){
...
},{"../../common/EventEmitter":1,"../../common/domUtils":5,"../../common/inherits":6}],15:[function(require,module,exports){
...
},{"../../common/Texture":3}],16:[function(require,module,exports){
// helper functions
...
},{"../../common/assetLoader":4,"./Brush.js":7,"./MapEditorPanel.js":9,"./MapListPanel.js":10,"./PalettePanel.js":11,"./Panel.js":12,"./SpriteSheetPanel.js":13,"./keyboard.js":18}],18:[function(require,module,exports){
var EventEmitter = require('../../common/EventEmitter');
var Panel        = require('./Panel.js');
...
},{"../../common/EventEmitter":1,"./Panel.js":12}],19:[function(require,module,exports){
var addTooltip = require('./tooltip.js');
var domUtils   = require('../../common/domUtils');
...
},{"../../common/domUtils":5,"./tooltip.js":20}],20:[function(require,module,exports){
var createDiv = require('../../common/domUtils').createDiv;
