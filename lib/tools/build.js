 ...
 * @property {MapItem[][]} items - 2D array of map items
...
AssetListPanel.prototype.addFileTo = function (fullPath, name, obj, parent) {
	if (obj instanceof Image) {
		...
		var type = obj._type;
		if (type === 'maps') {
			this.addMapBank(fullPath, obj.data);
 ...
 */
AssetListPanel.prototype.addMapBank = function (file, mapBank) {
	var t = this;
	...
	for (var i = 0; i < mapBank.maps.length; i++) {
		this.addMap(file, mapBank.maps[i]);
	}
};
...
},{"../../components/Map":2,"../../components/assetLoader":4,"../../components/domUtils":5,"../../components/inherits":6,"./FolderListItem":10,"./ListItem":11,"./Panel":14,"./dragManager":16,"./helper":18,"./resizeHandle":21,"./toolbox":22,"./tooltip":23}],8:[function(require,module,exports){
module.exports = {
	name: 'default brush',
...
},{"../../components/domUtils":5,"../../components/inherits":6,"./Brush":8,"./FolderListItem":10,"./Panel":14,"./helper":18,"./resizeHandle":21,"./toolbox":22,"./tooltip":23}],10:[function(require,module,exports){
var domUtils       = require('../../components/domUtils');
...
},{"../../components/domUtils":5,"./dragManager":16}],12:[function(require,module,exports){
var Panel        = require('./Panel');
var addTooltip   = require('./tooltip');
...
function MapEditorPanel() {
	...
	function startDraw(e) {
		...
		function mouseMove(e, isStart) {
			e.preventDefault();
			var x = ~~((e.clientX - canvasPosition.left) / SPRITE_WIDTH  / PIXEL_SIZE);
			var y = ~~((e.clientY - canvasPosition.top)  / SPRITE_HEIGHT / PIXEL_SIZE);
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
MapEditorPanel.prototype.setBank = function (bank) {
	this.bank = bank;
};
...
},{"../../components/Map":2,"../../components/Texture":3,"../../components/assetLoader":4,"../../components/domUtils":5,"../../components/inherits":6,"./Panel":14,"./dragManager":16,"./grid":17,"./helper":18,"./keyboard":20,"./resizeHandle":21,"./tooltip":23}],13:[function(require,module,exports){
...
},{"../../components/domUtils":5,"../../components/inherits":6,"./Panel.js":14,"./dragManager.js":16}],14:[function(require,module,exports){
var domUtils      = require('../../components/domUtils');
...
},{"../../components/domUtils":5,"./zIndexManager":24}],15:[function(require,module,exports){
var Panel        = require('./Panel.js');
...
},{"../../components/Texture":3,"../../components/domUtils":5,"../../components/inherits":6,"./Panel.js":14,"./dragManager.js":16,"./grid.js":17,"./tooltip.js":23}],16:[function(require,module,exports){
...
},{"../../components/EventEmitter":1,"../../components/domUtils":5,"../../components/inherits":6,"./zIndexManager":24}],17:[function(require,module,exports){
...
},{"../../components/Texture":3}],18:[function(require,module,exports){
// helper functions
...
assetLoader.loadJson('toolSettings.json', function onToolSettingsLoaded(error, toolSettings) {
	...
	assetLoader.preloadStaticAssets(function onAssetsLoaded(error, result) {
		...
		toolbox.mapEditor.setBank(assets.maps);
		if (assets.maps.maps[0]) toolbox.mapEditor.loadMap(assets.maps.maps[0]); // FIXME
	});
});
...
},{"../../components/Map":2,"../../components/assetLoader":4,"./toolbox":22}],20:[function(require,module,exports){
var EventEmitter = require('../../components/EventEmitter');
var Panel        = require('./Panel.js');
...
},{"../../components/EventEmitter":1,"./Panel.js":14}],21:[function(require,module,exports){
var addTooltip = require('./tooltip.js');
var domUtils   = require('../../components/domUtils');
...
},{"../../components/domUtils":5,"./tooltip.js":23}],22:[function(require,module,exports){
var Panel       = require('./Panel.js');
var PixelboxMap = require('../../components/Map');
...
},{"../../components/Map":2,"./AssetListPanel.js":7,"./CustomToolsPanel.js":9,"./MapEditorPanel.js":12,"./PalettePanel.js":13,"./Panel.js":14,"./SpriteSheetPanel.js":15,"./keyboard.js":20}],23:[function(require,module,exports){
var createDiv     = require('../../components/domUtils').createDiv;
var zIndexManager = require('./zIndexManager');
...
},{"../../components/domUtils":5,"./zIndexManager":24}],24:[function(require,module,exports){
var zIndex = 0;
var elements = [];
