...
Texture.prototype.draw = function (img, x, y, flipH, flipV, flipR) {
	if (img._isTileMap) img = img.texture.canvas;
...
Tile.prototype.draw = function (texture) {
	texture.sprite(this.sprite, this.x * TILE_WIDTH, this.y * TILE_HEIGHT, this.flipH, this.flipV, this.flipR);
};
 ...
 */
TileMap.prototype.set = function (x, y, tile, flipH, flipV, flipR, flagA, flagB) {
...
},{"../Texture":2}],4:[function(require,module,exports){
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
/**
 * @module assetLoader
...
function MapListItem(file, index, map, rootDom) {
	...
	button(this.idxDom, function onDragButtonTap(e) {
		...
		var map = new TileMap().load(t.map);
...
},{"../../components/TileMap":3,"../../components/assetLoader":4,"../../components/domUtils":5,"../../components/inherits":6,"./FolderListItem":10,"./FolderPanel":11,"./ListItem":12,"./dragManager":17,"./helper":19,"./resizeHandle":23,"./toolbox":24,"./tooltip":25}],8:[function(require,module,exports){
module.exports = {
	name: 'default brush',
...
},{"../../components/domUtils":5,"../../components/inherits":6,"./Brush":8,"./FolderListItem":10,"./FolderPanel":11,"./helper":19,"./resizeHandle":23,"./toolbox":24,"./tooltip":25}],10:[function(require,module,exports){
var domUtils  = require('../../components/domUtils');
...
},{"../../components/Texture":2,"../../components/TileMap":3,"../../components/assetLoader":4,"../../components/domUtils":5,"../../components/inherits":6,"./Panel":15,"./dragManager":17,"./grid":18,"./helper":19,"./keyboard":21,"./resizeHandle":23,"./tooltip":25}],14:[function(require,module,exports){
...
Panel.prototype.setPosition = function (x, y) {
	...
	this.y = Math.max(HEADER_HEIGHT, Math.min(maxY, this.y));
...
},{"../../components/domUtils":5,"./zIndexManager":26}],16:[function(require,module,exports){
var Panel        = require('./Panel.js');
...
},{"../../components/Texture":2,"../../components/domUtils":5,"../../components/inherits":6,"./Panel.js":15,"./dragManager.js":17,"./grid.js":18,"./tooltip.js":25}],17:[function(require,module,exports){
...
},{"../../components/EventEmitter":1,"../../components/domUtils":5,"../../components/inherits":6,"./zIndexManager":26}],18:[function(require,module,exports){
...
},{"../../components/Texture":2}],19:[function(require,module,exports){
// helper functions
...
},{"../../components/Texture":2,"../../components/TileMap":3,"../../components/assetLoader":4,"./toolbox":24}],21:[function(require,module,exports){
var EventEmitter = require('../../components/EventEmitter');
var Panel        = require('./Panel.js');
...
},{"../../components/assetLoader":4,"../../components/domUtils":5}],23:[function(require,module,exports){
var addTooltip = require('./tooltip.js');
var domUtils   = require('../../components/domUtils');
...
},{"../../components/domUtils":5,"./tooltip.js":25}],24:[function(require,module,exports){
var Panel   = require('./Panel.js');
var TileMap = require('../../components/TileMap');
...
},{"../../components/TileMap":3,"./AssetListPanel.js":7,"./CustomToolsPanel.js":9,"./MapEditorPanel.js":13,"./PalettePanel.js":14,"./Panel.js":15,"./TileSheetPanel.js":16,"./keyboard.js":21,"./menuHeader.js":22}],25:[function(require,module,exports){
var createDiv     = require('../../components/domUtils').createDiv;
var zIndexManager = require('./zIndexManager');
...
},{"../../components/domUtils":5,"./zIndexManager":26}],26:[function(require,module,exports){
var zIndex = 0;
var elements = [];
